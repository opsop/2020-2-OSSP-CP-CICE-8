...
""" dict comprehension suggestion

mm = [{
    "title": News.news_list[i].title,
    "description": News.news_list[i].date,
    "thumbnail": {
        "imageUrl": News.news_list[i].image_url},
    "buttons": [
        {
            "action": "webLink",
            "label": "자세히 보러가기",
            "webLinkUrl": News.news_list[i].link
        }
    ]
} for i in news_num]
"""
