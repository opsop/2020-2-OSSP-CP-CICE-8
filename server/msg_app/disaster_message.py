...
decode_key = unquote('O25gUy60KqtQ%2B0JSuKlerJKpJxLyZNK4OHXqxZArRcQVzeS5iqA3G6jHNJIBiFnHA%2BQPBstl32Ua6zW%2Bc2aQ8Q%3D%3D')
...
def get_emergency_alerts(page_number):
    queryParams = '?' + urlencode({ quote_plus('ServiceKey') : decode_key, quote_plus('pageNo') : page_number,                     quote_plus('numOfRows') : '10', quote_plus('type') : 'json', quote_plus('flag') : 'Y' })
